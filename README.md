...
### **Desarrollador de Software** @ [SATEC](https://www.satec.es)
`Jul 2024 - Presente`  
- Diseño de arquitectura de microservicios con Spring Boot
- Desarrollo de aplicaciones empresariales con Angular
- Implementación de autenticación con Keycloak (OAuth2/JWT)
- Configuración de pipelines CI/CD con GitLab y Kubernetes
- Optimización de rendimiento frontend (Lazy Loading, SSR)

### **Becario Desarrollo Web** @ [SESCAM](https://sescam.castillalamancha.es)
`Abr 2024 - Jul 2024`  
- Desarrollo de componentes Angular reutilizables
